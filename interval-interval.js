...
var interval_number_1 = require("./interval-number");
...
var Interval = /** @class */ (function () {
     ...
     */
    Interval.prototype.hasInnerBounds = function () {
    ...
    Interval.prototype.toString = function () {
        ...
        else if (this.start.toString() === 'NaN') {
            rStr += 'nan';
        }
        else {
            rStr += this.start;
     ...
     */
    Interval.prototype.getStart = function () {
        return this.start;
    };
    /**
     * Returns the end, or upper bound
     */
    Interval.prototype.getEnd = function () {
        return this.end;
    };
    /**
     * Returns the start, or lower bound
     */
    Interval.prototype.getLower = function () {
        return this.start;
    };
    /**
     * Returns the end, or upper bound
     */
    Interval.prototype.getUpper = function () {
        return this.end;
    };
    /**
     * Adds a constant from this interval or adds this interval to another interval, returning the result as an array.
     */
    Interval.prototype.add = function (ii) {
        var _this = this;
        var rarray = new Array();
        if (ii instanceof interval_number_1.IntervalNumber || typeof (ii) === 'number') {
            var constant = void 0;
            if (ii instanceof interval_number_1.IntervalNumber) {
            ...
            ii.forEach(function (i) { rarray.push(new Interval(_this.start + i.start, _this.end + i.end)); });
        }
        return rarray;
    };
    /**
     ...
     */
    Interval.prototype.subtract = function (ii) {
        var _this = this;
        var rarray = new Array();
        if (ii instanceof interval_number_1.IntervalNumber || typeof (ii) === 'number') {
            var constant = void 0;
            ...
            ii.forEach(function (i) { rarray.push(new Interval(_this.start - i.end, _this.end - i.start)); });
        }
        return rarray;
    };
    /**
     ...
     */
    Interval.prototype._multiply = function (ii) {
        ...
        if (xl < 0) {
            if (xu > 0) {
                if (yl < 0) {
                    if (yu > 0) {
                        return (new Interval(Math.min(xl * yu, xu * yl), Math.max(xl * yl, xu * yu)));
                    }
                    else {
                        return (new Interval(xu * yl, xl * yl));
                    }
                }
                else {
                    if (yu > 0) {
                        return (new Interval(xl * yu, xu * yu));
                    }
                    else {
                ...
                if (yl < 0) {
                    if (yu > 0) {
                        return (new Interval(xl * yu, xl * yl));
                    }
                    else {
            ...
            if (xu > 0) {
                if (yl < 0) {
                    if (yu > 0) {
                        return (new Interval(xu * yl, xu * yu));
                    }
                    else {
     ...
     */
    Interval.prototype.multiply = function (ii) {
        var _this = this;
        var rarray = new Array();
        if (ii instanceof interval_number_1.IntervalNumber || typeof (ii) === 'number') {
            var constant = void 0;
            ...
            ii.forEach(function (i) { rarray.push(_this._multiply(i)); });
        }
        return rarray;
    };
    /**
     ...
     */
    Interval.prototype._divide = function (ii) {
        //    template<class T, class Policies> inline
        // interval<T, Policies> operator/(const interval<T, Policies>& x,
        //                                const interval<T, Policies>& y)
        // {
        ...
        if (ii.hasZero()) {
            if (!(ii.start === 0)) {
                if (!(ii.end === 0)) {
                    return (interval_utility_1.div_zero(this));
                }
                else {
                    return (interval_utility_1.div_negative(this, ii.start));
                }
            }
            else {
                if (!(ii.end === 0)) {
                    return (interval_utility_1.div_positive(this, ii.end));
                }
                else {
    ...
    Interval.prototype.divide = function (ii) {
        ...
        if (typeof (ii) === 'number' || ii instanceof interval_number_1.IntervalNumber) {
            ...
            ii.forEach(function (i) { rarray.push(_this._divide(i)); });
        }
        return (rarray);
    };
    /**
     ...
     */
    Interval.prototype.wrapAroundInterval = function (ii) {
        var rarray = new Array();
     ...
     */
    Interval.prototype.hasZero = function () {
